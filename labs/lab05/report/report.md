...
Перехожу в созданный каталог лабораторной работы 5 (рис. -@fig:003).
...
Транслирую и компоную измененный файл, запускаю (рис. -@fig:0086.
...
![Редактирование копии](image/9.png){#fig:014 width=70%}
